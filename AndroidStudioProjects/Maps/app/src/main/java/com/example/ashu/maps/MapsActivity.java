...
//        Called when the dragging starts
    ...
    public void onLocationChanged(Location location) {
        ...
        LatLng test =  new LatLng(28,77);
        Log.e("LOcation", "onLocationChanged: "+location.getLongitude());
        mMap.animateCamera(CameraUpdateFactory.newLatLng(test));
        PolylineOptions polylineOptions = new PolylineOptions()
                .add(currentLocation,lastLocation);
